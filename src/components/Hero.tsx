...
const slides = [
  {
    ...
    description: 'Oméga24 Consulting vous accompagne dans toutes vos démarches : orientation, admission, visa, logement et bien plus encore.',
  ...
  },
  {
    ...
    description: "Nous vous aidons à décrocher un emploi dans plus de 13 pays : Allemagne, Canada, Qatar, et bien d'autres. Accompagnement complet du CV au contrat.",
  ...
  },
  {
    ...
    description: 'Assurance santé, voyage, habitation, auto & moto — Oméga24 Consulting vous protège et sécurise votre avenir et celui de vos proches.',
